...
public class MVTabLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public MVTabLayout(Context context) {
        this(context, null);
    }

    public MVTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MVTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        tabs = new LinkedList<MVMaterialTab>();
    ...
    public void addTab(MVMaterialTab tab) {
    ...
    public MVMaterialTab getCurrentTab() {
        for(MVMaterialTab tab : tabs) {
            if (tab.isSelected())
                return tab;
        }

...
public class MVColorView extends ViewGroup {
	...
	public MVColorView(Context context) {
		this(context, null);
	}

	public MVColorView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public MVColorView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		Utils.setBackground(inkView, circle);
